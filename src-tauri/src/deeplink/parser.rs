...
//!
//! Parses ccswitchproxy:// URLs into DeepLinkImportRequest structures.
...
/// Parse a ccswitchproxy:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// ccswitchproxy://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "ccswitchproxy" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'ccswitchproxy', got '{scheme}'"
        )));
    }
